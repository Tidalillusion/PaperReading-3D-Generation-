...
I have divide this into 4 parts: (1) Use the 3DGS <br>(2) Use the NeFR <br>(3) Use the Diffusion model (4)Other related papers(such as dataset, 2D generation, other 3D generation).
