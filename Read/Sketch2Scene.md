...
![authors](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/sketch2scene-1authors.jpg)
...
下图为Isometric image的示例。

![Isometric_image](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/sketch2scene-2IosmetricImageExample.jpg)
...
![overview](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/sketch2Scene-3overview.jpg)
...
![SAL](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-4SAIDiffusion.jpg)
...
![SUD](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-6AlgorithmSUD.jpg)

### 2.visual scene understanding
<p>&emsp;&emsp;这里将三维场景分解为三个部分：1.高度图 2.纹理splatmap 3.前景。 分别控制场景地形形状、场景地形纹理以及地形上对象的种类、位置、姿态。

![understanding](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-7UnderstandingExample.jpg)
...
![eg](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-8Footprint23DLocation.jpg)
...
![result](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-9%203DReconstructionResult.jpg)
...
![controlnet](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-10ControlNetDiversity.jpg)

#### 3.内绘结果比较
<p>&emsp;&emsp;可以发现与Baseline（保留了人造地物）相比，本文内绘方法可以获得更加纯净的地形信息。
  
![inpaiting](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-11BasemapResults.jpg)

#### 4.视觉场景理解模块
<p>&emsp;&emsp;展示了生成的高度图、BEV三维实例放置示意图以及参考三维实例图。
  
![understanding](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-12UnderstandingResults.jpg)

#### 5.程序化三维生成结果
<p>&emsp;&emsp;下图a为使用数据库检索的场景重建结果，b、c为生成结果。
  
![understanding](https://github.com/Tidalillusion/PaperReading-3D-Generation-/blob/main/Read/Image/Sketch2Scene-13TwoGenerationWays.jpg)
